...
export const ROLE_PRESETS: Record<OfferLetterRoleType, RolePresetData> = {
  ...
  pr_intern: {
    ...
    incentiveDetails: 'Performance-based incentive on closed corporate sponsor deals and partner MoUs.',
    workingHours: '20-25 Hours/Week (Flexible)',
    reportingManager: 'Head of Public Relations & Strategic Partnerships',
    employmentType: 'Internship',
    workMode: 'Remote (Work From Home)',
    responsibilities: [
      'Identify, research, and pitch prospective corporate brand sponsors and tech companies to sponsor AEW events.',
      'Draft and present corporate sponsorship pitch decks highlighting student developer reach and branding assets.',
      'Coordinate and execute formal Memorandums of Understanding (MoUs) for corporate sponsorships and event tracks.',
      'Lead and nurture the AEW Campus Ambassador network across designated university clusters.',
      'Ensure execution of all agreed corporate sponsor deliverables during hackathons and compile post-event impact reports.',
      'Represent Apna Engineering Wallah professionally in corporate outreach calls and partnership discussions.',
    ],
  },
  pr_head: {
    roleType: 'pr_head',
    label: 'PR Head',
    defaultTitle: 'Head of Public Relations & Corporate Partnerships',
    department: 'Public Relations & Strategic Growth',
    duration: '6 Months',
    stipendAmount: '₹35,000 / Month',
    incentiveDetails: 'Executive commission of up to 15% on closed corporate sponsor deals and partner alliances.',
    workingHours: '35-40 Hours/Week',
    reportingManager: 'Director of Growth & Strategic Partnerships',
    employmentType: 'Full-time',
    workMode: 'Hybrid',
    responsibilities: [
      'Lead and mentor the PR and Outreach team to achieve corporate sponsorship and brand alliance revenue targets.',
      'Identify and pitch top tech firms, SaaS companies, and consumer brands to sponsor AEW hackathons and fests.',
      'Negotiate high-value corporate sponsorship agreements, Memorandums of Understanding (MoUs), and deliverables.',
      'Oversee sponsor ROI, stage branding, resume book distribution, and corporate keynote sessions.',
      'Architect national campus outreach campaigns and scale the student developer ambassador ecosystem.',
      'Represent AEW in executive brand meetings, tech summits, and industry partnership roundtables.',
    ],
  },
  web_dev_intern: {
